...
export default function About() {
  return (
    ...
    >
      ...
      >
        About{' '}
        <span style={{ color: 'var(--noto-primary)' }}>NOTO</span>
      </h1>

      <div className="space-y-6 text-base leading-relaxed" style={{ color: 'var(--noto-text-secondary)' }}>
        <p>
          NOTO is an elite educational archive, built to empower ambitious students preparing for the most rigorous academic examinations globally.
        </p>
        <p>
        ...
        <p>
          NOTO is continually evolving. Beyond the curated library, we are building AI-powered tools — smart roadmaps, RAG chat, flashcards, mock exams, and more — to give every student an unfair advantage in their academic journey.
        </p>
      </div>
    </motion.div>
  );
